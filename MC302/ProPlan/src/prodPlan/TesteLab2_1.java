...
public class TesteLab2_1 {
	...
	static Parte[] criaPartes() {
		...
		res[0] = new Motor(112, "motor m112", "motor de avanço do cabeçote",
		...
		res[4] = new Parafuso(231, "parafuso p1",
				"parafuso de fixação do cabeçote", 2.5f, 100.0f, 8.0f);
		res[5] = new Parafuso(232, "parafuso p2",
				"parafuso de fixação do motor", 2.5f, 80.0f, 6.0f);
		res[6] = new Parafuso(233, "parafuso p3",
				"parafuso de fixação do ventilador", 2.0f, 60.0f, 6.0f);
